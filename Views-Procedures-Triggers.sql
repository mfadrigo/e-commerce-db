...
-- 2. Find the highest price for each item sold by the seller with user id ‘S3AB0’ for each category of item where they’ve had sales. Print the item_id, item_name, category, and price of these highest-price items. Rank the output by price from highest to lowest.
